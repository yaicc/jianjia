/* 引入css */
(function($) {
	$('body').append($('<link rel="stylesheet" type="text/css" href="/static/simditor/styles/font-awesome.css" />'));
	$('body').append($('<link rel="stylesheet" type="text/css" href="/static/simditor/styles/simditor.css" />'));
	$('body').append($('<link rel="stylesheet" type="text/css" href="/static/simditor/styles/simditor-emoji.css" />'));
}(window.jQuery));
/* module */

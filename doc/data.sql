...
CREATE TABLE `comments` (
  ...
  `reply` int(10) NOT NULL DEFAULT '0' COMMENT '回复',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '状态，1-锁定，0-正常',
  `postdate` int(10) NOT NULL COMMENT '发布时间',
  PRIMARY KEY (`cid`),
  KEY `idx_comment_topic` (`tid`),
  KEY `idx_comment_user` (`uid`)
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 CHECKSUM=1 DELAY_KEY_WRITE=1 ROW_FORMAT=DYNAMIC COMMENT='评论表';

/*Data for the table `comments` */

insert  into `comments`(`cid`,`tid`,`uid`,`username`,`comment`,`reply`,`status`,`postdate`) values (1,2,1,'乔豆麻袋','<p>好得很</p>',0,0,1415670244),(2,2,1,'乔豆麻袋','<p>我在街角杂品店前停下来吃早餐。因为有些迟了，便急匆匆地吃了些炸面圈，喝了咖啡后就急步走进地铁站，跑下台阶，赶上了我常搭的那趟列车。我抓住吊带，装作看报，却不停地扫视这些挤在我周围的人们。他们还是我每天看到的人。他们认识我，我也认识他们，我们却没有微笑，像是偶遇的陌生人。</p><p>									</p>',0,0,1415674261),(3,2,1,'乔豆麻袋','<p>									</p><p><img alt=\\\"yu-hua.jpg\\\" src=\\\"http://jianjia.club//uploads/201411/fb71d8f830ed28bb695ba9058173d8bb.jpg\\\"><br></p><p>相对来说，我更喜欢余华的文章。</p>',0,1,1415675512),(4,2,1,'乔豆麻袋','<p>我也觉得</p>',1,0,1415691650),(5,2,1,'乔豆麻袋','<p>不能再同意更多</p>',4,0,1415692451),(6,2,1,'乔豆麻袋','<p>不能再同意更多</p>',4,0,1415692791),(7,2,1,'乔豆麻袋','<p>不能再同意更多</p>',4,0,1415692843),(8,2,1,'乔豆麻袋','<p>测试一下大家伙</p>',3,0,1415693525),(9,2,1,'乔豆麻袋','<p>测试</p>',2,0,1415693927),(10,2,1,'乔豆麻袋','<p>有些事情向来确实是这样</p>',9,0,1415696574);
